...
from accounts.views import register, activate_view, authentication_view, Reset_Pwd_Code, login, reg_Verification, getProfile, Modify_Pwd, Modify_Pwd_By_Old, updateAvatar, update_profile
